...
<div class="lang-head-elements">
    ...
    <li>Знакомство с Python: история, применение, особенности.</li>
    <li>Установка Python и интерпретатора.</li>
    <li>Первая программа на Python: "Hello, World!"</li>
    <h3>Урок 2: Переменные и типы данных</h3>
    <li>Объявление и использование переменных.</li>
    <li>Основные типы данных в Python: числа, строки, списки, кортежи, словари.</li>
    <li>Примеры работы с различными типами данных.</li>
    <h3>Урок 3: Условия и циклы</h3>
    <li>Условные операторы (if, else) и их применение.</li>
    <li>Циклы: for и while.</p>
    <li>Примеры использования условий и циклов.</li>
    <h3>Урок 4: Функции</h3>
    <li>Что такое функции и зачем их использовать.</li>
    <li>Определение функций и передача параметров.</li>
    <li>Возвращение значений из функций.</li>
    <li>Примеры простых функций.</li>
    <h3>Урок 5: Работа с файлами</h3>
    <li>Открытие, чтение и запись файлов в Python.</li>
    <li>Обработка и анализ данных из файлов.</li>
    <li>Примеры работы с файлами.</li>
    <h3>Урок 6: Структуры данных</h3>
    <li>Списки и их особенности.</li>
    <li>Кортежи и их использование.</li>
    <li>Словари: ключи и значения.</li>
    <li>Примеры работы со структурами данных.</li>
    <h3>Урок 7: Модули и стандартная библиотека Python</h3>
    <li>Краткий обзор изученного материала.</li>
    <li>Решение задач и практических упражнений на Python.</li>
    <li>Создание простой программы, использующей разные концепции языка.</li>
    <h3>Урок 8: Итоговый проект и завершение курса</h3>
</div>
`;
